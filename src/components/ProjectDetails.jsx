          ...
          <div className="flex-1 sm:py-0 py-4">
            ...
            <div>
              ...
              <div className="w-full overflow-hidden bg-gray-300 mt-4">
                <div
                  className="bg-cyan-400 text-xs font-medium
              text-cyan-400 text-center p-0.5 leading-none
              ...
              <div className="flex justify-start items-center space-x-2 mt-4">
                {project?.status == 0 ? (
                  <button
                    type="button"
                    className="inline-block px-6 py-2.5 bg-cyan-400
              text-white font-medium text-xs leading-tight uppercase
              rounded-full shadow-md hover:bg-cyan-500"
